...
def webui_req():
    time.sleep(1)
    pull(f"https://github.com/ositoMalvado/sksd cui {WEBUI}")
...
def webui_widgets():
    if WEBUI.exists():
        ...
        x = [
            f"https://github.com/ositoMalvado/sksd/raw/main/script/controlnet/controlnet.py {WEBUI}/asd",
            f"https://github.com/ositoMalvado/sksd/raw/main/script/venv.py {WEBUI}",
            f"https://github.com/ositoMalvado/sksd/raw/main/ui/cui/apotek.py {WEBUI}",
            f"https://github.com/ositoMalvado/sksd/raw/main/ui/cui/launch.py {WEBUI}",
            f"https://github.com/ositoMalvado/sksd/raw/main/script/multi/sksd.py {WEBUI}"
        ]
